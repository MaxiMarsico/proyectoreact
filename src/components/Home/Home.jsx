  ...
  return (
    ...
    <div className=' container fluid flex-col '>
      <div  className="home w-screen h-full flex justify-center ">
        <div className=" w-5/6 h-full grid grid-cols-2 items-center bg-themeOrange border-solid rounded-b-full">
          ...
          <div className="flex justify-end  h-full">
            <img src={bg_dog} alt="background dog" className="w-1/2 mt-20 md:mr-20 h-98"/>
          </div>
        </div>  
      </div>
      <div className='wave w-screen'>
          <img src={wave} alt="wave" className='w-full -mt-16 md:-mt-24' />
      </div>
    </div>
  )
}
